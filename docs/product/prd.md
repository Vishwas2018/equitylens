...
To become the **operating system for Australian property investors** by giving households and their advisers a single, trusted, deterministic view of *real* portfolio profitability, tax position, equity trajectory, and hold-versus-sell economics — explained in plain language by AI, but **never calculated** by AI.
...
5. **Hold/sell intelligence** — no Australian competitor models the *opportunity cost net of CGT and re-entry stamp duty* cleanly. This is the killer feature.
...
1. Lands on marketing site → "How profitable is *your* IP, really?" hook.
