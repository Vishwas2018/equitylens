...
export const SubscriptionStatus    = z.enum(['trialing','active','past_due','cancelled','incomplete']);
...
export interface Database {
  public: {
    Tables: {
      organisations:             { Row: OrganisationRow;            Insert: Omit<OrganisationRow,'id'|'created_at'|'updated_at'|'deleted_at'>;            Update: Partial<OrganisationRow> };
      user_org_membership:       { Row: UserOrgMembershipRow;       Insert: Omit<UserOrgMembershipRow,'id'|'created_at'>;                                  Update: Partial<UserOrgMembershipRow> };
      subscriptions:             { Row: SubscriptionRow;            Insert: Omit<SubscriptionRow,'id'|'created_at'|'updated_at'>;                         Update: Partial<SubscriptionRow> };
      portfolios:                { Row: PortfolioRow;               Insert: Omit<PortfolioRow,'id'|'created_at'|'updated_at'|'deleted_at'>;               Update: Partial<PortfolioRow> };
      properties:                { Row: PropertyRow;                Insert: Omit<PropertyRow,'id'|'created_at'|'updated_at'|'deleted_at'>;                Update: Partial<PropertyRow> };
      property_ownership_splits: { Row: PropertyOwnershipSplitRow;  Insert: Omit<PropertyOwnershipSplitRow,'id'|'created_at'>;                            Update: Partial<PropertyOwnershipSplitRow> };
      property_ppor_history:     { Row: PpoREntryRow;               Insert: Omit<PpoREntryRow,'id'>;                                                      Update: Partial<PpoREntryRow> };
      loans:                     { Row: LoanRow;                    Insert: Omit<LoanRow,'id'|'created_at'|'updated_at'|'deleted_at'>;                    Update: Partial<LoanRow> };
      income_records:            { Row: IncomeRecordRow;            Insert: Omit<IncomeRecordRow,'id'|'created_at'|'updated_at'>;                         Update: Partial<IncomeRecordRow> };
      expense_records:           { Row: ExpenseRecordRow;           Insert: Omit<ExpenseRecordRow,'id'|'created_at'|'updated_at'>;                        Update: Partial<ExpenseRecordRow> };
      depreciation_schedules:    { Row: DepreciationScheduleRow;    Insert: Omit<DepreciationScheduleRow,'id'|'created_at'>;                              Update: Partial<DepreciationScheduleRow> };
      depreciation_line_items:   { Row: DepreciationLineItemRow;    Insert: Omit<DepreciationLineItemRow,'id'>;                                           Update: Partial<DepreciationLineItemRow> };
      tax_rule_sets:             { Row: TaxRuleSetRow;              Insert: TaxRuleSetRow;                                                                Update: Partial<TaxRuleSetRow> };
      scenarios:                 { Row: ScenarioRow;                Insert: Omit<ScenarioRow,'id'|'created_at'>;                                          Update: Partial<ScenarioRow> };
      scenario_results:          { Row: ScenarioResultRow;          Insert: Omit<ScenarioResultRow,'id'|'created_at'>;                                    Update: never };
      ai_interactions:           { Row: AiInteractionRow;           Insert: Omit<AiInteractionRow,'id'|'created_at'>;                                     Update: never };
      audit_logs:                { Row: AuditLogRow;                Insert: Omit<AuditLogRow,'id'|'occurred_at'>;                                         Update: never };
      report_jobs:               { Row: ReportJobRow;               Insert: Omit<ReportJobRow,'id'|'requested_at'|'completed_at'>;                        Update: Partial<ReportJobRow> };
    };
  };
}
