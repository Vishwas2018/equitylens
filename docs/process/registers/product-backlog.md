...
| BL-0022 | Migrate Next.js 14.2.29 → 15.x                                                                             | P0       | M      | DEF-0001                                           | in_plan  | Day 13, D13-T-CVE. Hard stop — no further deferral.                                                                                                                  |
...
| BL-0029 | Postgres RLS isolation integration tests — cross-tenant JWT probe against real Supabase                    | P0       | S      | D08-T4 (app-layer scoping only)                    | in_plan  | Day 13, D13-T2/T3. Technique A (SET LOCAL) + Technique B (Supabase JS JWT, no app filter).                                                                           |
