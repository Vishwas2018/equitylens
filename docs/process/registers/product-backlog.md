...
| BL-0030 | OpenAI fallback in AI gateway — structural stub, never functionally exercised                              | P1       | S      | D11-T3 (Q1=A decision)                             | in_plan  | Day 14/D15-T0. DONE before RC walkthrough. If D14 Stripe runs long → D15-T0 (not parallel with RC review).                                                            |
